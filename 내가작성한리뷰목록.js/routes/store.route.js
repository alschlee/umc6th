...
import { addMissionToStoreController, challengeMissionController, getStoreMissionsController, getOngoingMissionsController } from '../controllers/store.controller.js';
...
// 내가 진행 중인 미션 목록 조회
storeRouter.get('/ongoing-missions', getOngoingMissionsController);
